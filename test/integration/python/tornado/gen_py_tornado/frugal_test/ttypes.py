...
class VersioningTestV2:
  ...
  def write(self, oprot):
    ...
    if self.newmap is not None:
      ...
      for kiter37,viter38 in self.newmap.items():
...
class GuessProtocolStruct:
  ...
  def write(self, oprot):
    ...
    if self.map_field is not None:
      ...
      for kiter60,viter61 in self.map_field.items():
...
class LargeDeltas:
      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i72 in xrange(_size68):
            ...
            self.big_numbers.append(_elem73)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
  ...
  def write(self, oprot):
    ...
    if self.big_numbers is not None:
      ...
      for iter75 in self.big_numbers:
...
class NestedListsI32x2:
      ...
      if fid == 1:
        if ftype == TType.LIST:
          ...
          for _i80 in xrange(_size76):
            ...
            iprot.readListEnd()
            self.integerlist.append(_elem81)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
  ...
  def write(self, oprot):
    ...
    if self.integerlist is not None:
      ...
      for iter88 in self.integerlist:
        oprot.writeListBegin(TType.I32, len(iter88))
...
class NestedListsI32x3:
      ...
      if fid == 1:
        if ftype == TType.LIST:
          ...
          for _i94 in xrange(_size90):
            ...
            iprot.readListEnd()
            self.integerlist.append(_elem95)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
  ...
  def write(self, oprot):
    ...
    if self.integerlist is not None:
      oprot.writeFieldBegin('integerlist', TType.LIST, 1)
      oprot.writeListBegin(TType.LIST, len(self.integerlist))
      for iter108 in self.integerlist:
        oprot.writeListBegin(TType.LIST, len(iter108))
        for iter109 in iter108:
          oprot.writeListBegin(TType.I32, len(iter109))
...
class NestedMixedx2:
        ...
        if ftype == TType.LIST:
          ...
          for _i115 in xrange(_size111):
            ...
            for _i121 in xrange(_size117):
              ...
              _elem116.add(_elem122)
            iprot.readSetEnd()
            self.int_set_list.append(_elem116)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      elif fid == 2:
        if ftype == TType.MAP:
          ...
          for _i127 in xrange(_size123):
            ...
            for _i134 in xrange(_size130):
              ...
              _val129.add(_elem135)
            iprot.readSetEnd()
            self.map_int_strset[_key128] = _val129
          iprot.readMapEnd()
        else:
          iprot.skip(ftype)
      elif fid == 3:
          ...
          for _i140 in xrange(_size136):
            ...
            for _i146 in xrange(_size142):
              ...
              for _i153 in xrange(_size149):
                ...
                _val148.add(_elem154)
              iprot.readSetEnd()
              _elem141[_key147] = _val148
            iprot.readMapEnd()
            self.map_int_strset_list.append(_elem141)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
  ...
  def write(self, oprot):
    ...
    if self.int_set_list is not None:
      ...
      for iter155 in self.int_set_list:
        oprot.writeSetBegin(TType.I32, len(iter155))
    ...
    if self.map_int_strset is not None:
      ...
      for kiter157,viter158 in self.map_int_strset.items():
        oprot.writeI32(kiter157)
        oprot.writeSetBegin(TType.STRING, len(viter158))
    ...
    if self.map_int_strset_list is not None:
      ...
      for iter160 in self.map_int_strset_list:
        oprot.writeMapBegin(TType.I32, TType.SET, len(iter160))
        for kiter161,viter162 in iter160.items():
          oprot.writeI32(kiter161)
          oprot.writeSetBegin(TType.STRING, len(viter162))
...
class NestedListsBonk:
          ...
          for _i175 in xrange(_size171):
            ...
            for _i181 in xrange(_size177):
              ...
              for _i187 in xrange(_size183):
                _elem188 = Bonk()
                _elem188.read(iprot)
                _elem182.append(_elem188)
              iprot.readListEnd()
              _elem176.append(_elem182)
            iprot.readListEnd()
            self.bonk.append(_elem176)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
  ...
  def write(self, oprot):
    ...
    if self.bonk is not None:
      ...
      for iter189 in self.bonk:
        oprot.writeListBegin(TType.LIST, len(iter189))
        for iter190 in iter189:
          oprot.writeListBegin(TType.STRUCT, len(iter190))
