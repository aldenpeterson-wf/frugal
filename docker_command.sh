...
docker run --name tester -it  -v "/Users/aldenpeterson/go/src/github.com/Workiva/frugal":"/frugal" drydock-prod.workiva.net/workiva/messaging-docker-images:119185 /bin/bash
